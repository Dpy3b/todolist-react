...
// функция для подсчета количества страниц, принимает аргументами общее количество постов и лимит постов на страницу
export const getPageCount = (totalCount, limit) => {
	return Math.ceil(totalCount / limit); // округляем в большую сторону
};

// улучшенный вариант, свой кастомный хук основанный на useMemo
